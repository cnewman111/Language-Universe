...
class ConversationsTest < ApplicationSystemTestCase
  ...
  test "should create conversation" do
    ...
    fill_in "Native language", with: @conversation.native_language
    fill_in "Prompt", with: @conversation.prompt_id
    fill_in "Training language", with: @conversation.training_language
